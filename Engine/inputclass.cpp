...
void InputClass::ProcessInput()
{
	...
	{
		m_mouse_Delta_X = m_mouseState.lX;
		m_mouse_Delta_Y = m_mouseState.lY;
	}
	else
	{
		m_mouse_Delta_X = 0.0f;
...
float InputClass::GetMouseDelta_X()
{
	return m_mouse_Delta_X;
}

float InputClass::GetMouseDelta_Y()
{
...
bool InputClass::IsMouseMovingLeftOrRight()
{
	if (m_mouse_Delta_X != 0.0f)
	{
		return true;
	}
	else
...
bool InputClass::IsMouseMovingUpOrDown()
{
	if (m_mouse_Delta_Y != 0.0f)
	{
		return true;
	}
	else
...
void InputClass::DisableMouse()
{
	disableMouse = true;
}

void InputClass::EnableMouse()
{
	disableMouse = false;
}
