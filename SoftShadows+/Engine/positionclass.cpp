...
void PositionClass::MoveForward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_forwardSpeed > (m_frameTime * 0.0035f))
		{
			m_forwardSpeed = m_frameTime * 0.0035f;
		}
	}
	else
	{
...
void PositionClass::MoveBackward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_backwardSpeed > (m_frameTime * 0.0035f))
		{
			m_backwardSpeed = m_frameTime * 0.0035f;
		}
	}
	else
	{
...
void PositionClass::MoveLeft(bool keydown)
{
	...
	if (keydown)
	{
		...
		if (m_leftSpeed > (m_frameTime * 0.0035f))
		{
			m_leftSpeed = m_frameTime * 0.0035f;
		}
	}
	else
	{
...
void PositionClass::MoveRight(bool keydown)
{
	...
	if (keydown)
	{
		...
		if (m_rightSpeed > (m_frameTime * 0.0035f))
		{
			m_rightSpeed = m_frameTime * 0.0035f;
		}
	}
	else
	{
...
void PositionClass::MoveUpward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_upwardSpeed > (m_frameTime * 0.0035f))
		{
			m_upwardSpeed = m_frameTime * 0.0035f;
		}
	}
	else
	{
...
void PositionClass::MoveDownward(bool keydown)
{
	...
	if(keydown)
	{
		...
		if(m_downwardSpeed > (m_frameTime * 0.0035f))
		{
			m_downwardSpeed = m_frameTime * 0.0035f;
		}
	}
	else
	{
...
void PositionClass::TurnLeftOrRight(float mouse_Delta_X)
{
	// Update the left turn speed movement based on the frame time and whether the user is holding the key down or not.
	
	m_rotationY += mouse_Delta_X * _MOUSESENSITIVITY_;
...
void PositionClass::TurnUpOrDown(float mouse_Delta_Y)
{
	// Update the left turn speed movement based on the frame time and whether the user is holding the key down or not.

	m_rotationX += mouse_Delta_Y * _MOUSESENSITIVITY_;
